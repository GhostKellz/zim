...
zlog = { git = "https://github.com/ghostkellz/zlog", ref = "v0.1.4" }

# Git dependency with commit hash
flash = { git = "https://github.com/ghostkellz/flash", ref = "abc123def456" }
...
**Location:** `.zim/policy.json`

Define security policies for dependency auditing.
...
- **allow**: Whitelist of allowed dependency sources (supports wildcards)
- **deny**: Blacklist of forbidden sources (takes precedence over allow)
- **require_hash**: Whether to require cryptographic hash verification

**Pattern Matching:**

- `github.com/*` - Matches all GitHub repositories
- `github.com/ghostkellz/*` - Matches specific organization
- `github.com/ghostkellz/zim` - Matches specific repository

**Enforcement:**

Configure enforcement level in `config.toml`:
...
Auto-generated file containing resolved dependency versions and hashes with full provenance tracking.
...
name = "zsync"
version = "1.0.0"
source = "gh/ghostkellz/zsync@main"
hash = "1220def456..."
dependencies = ["zpack"]

[package.provenance]
origin = "https://github.com/ghostkellz/zsync"
digest = "sha256:def456..."
fetched_at = "2024-11-15T10:31:00Z"
size = 98234
...
[package.provenance]
origin = "https://github.com/ghostkellz/zhttp"
digest = "sha256:567890..."
fetched_at = "2024-11-15T10:32:00Z"
size = 156789
```
...
This enables full supply chain security and reproducibility.

**See:** [Dependency Management Guide](DEPENDENCIES.md#lockfiles)
```
